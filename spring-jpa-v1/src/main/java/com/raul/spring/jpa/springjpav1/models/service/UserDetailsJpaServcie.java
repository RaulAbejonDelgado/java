...
@Service("userDetailsJpaServcie")
public class UserDetailsJpaServcie implements UserDetailsService {

    @Autowired
    IUserDao userDao;

    private Logger logger = LoggerFactory.getLogger(UserDetailsJpaServcie.class);
