package com.raul.spring.microservices.zuul.oauth;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.GET,"/api/products/list","/api/items/list").permitAll()
        .antMatchers(HttpMethod.GET,"/api/products/{id}","/api/items/{id}","/detail/{id}/quantity/{quantity}")
